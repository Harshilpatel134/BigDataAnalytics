...
object ImageClassification_RF {
  def main(args: Array[String]) {
    val IMAGE_CATEGORIES = Array("Man", "Baby", "Cell")
    ...
    val train = sc.textFile("F:\\ICP6\\CS5542-Tutorial3B-SourceCode\\ImageClassification\\data\\train")
    val test = sc.textFile("F:\\ICP6\\CS5542-Tutorial3B-SourceCode\\ImageClassification\\data\\test")
